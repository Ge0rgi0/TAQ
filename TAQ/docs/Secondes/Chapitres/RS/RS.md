...
Lorsqu’un service est gratuit, ce sont l’utilisateur, son attention et ses données qui financent la plateforme.
...
*Exemple :*
Après avoir recherché des montres sur Internet, des publicités similaires apparaissent sur Instagram ou YouTube.
...
>- **Youtube Premium** donne accés à la suppression des publicités, la lecture des vidéos en arrière-plan et aux téléchargements des vidéos pour un visionnage hors ligne.  

>Ces abonnements sont souvent destinés aux professionnels, aux créateurs de contenu, aux utilisateurs intensifs.
...
Les marques paient les réseaux sociaux pour que ceux-ci mettent en avant leurs produits sous forme de publicités.
Mais ce n’est pas la seule manière qu’elles ont de promouvoir leurs produits ou leurs événements en ligne.
...
Pour protéger les utilisateurs, la loi impose une indication claire du caractère publicitaire d’un contenu.
Les mentions telles que « sponsorisé », « partenariat rémunéré » ou « publicité » sont obligatoires.
...
<iframe width="400" height="300"
        src="https://www.youtube.com/embed/WEg5q-uIOpg"
        title="YouTube video player"
        frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen>
...
Les réseaux sociaux ne montrent pas tous les contenus publiés.
Ils utilisent des algorithmes pour décider quoi afficher dans le fil d’actualité, les stories ou les recommandations et dans quel ordre.
