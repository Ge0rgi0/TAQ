...
BALL_COLOR_YES = (230, 152, 215)
BALL_COLOR_NO = (103, 188, 214)
...
# Ajout : chargement de l'image pour le rectangle du haut
...
while running and frame_count < TOTAL_FRAMES:
    ...
    img_rect = img_disp.get_rect(centerx=SCREEN_WIDTH // 2, top=120)  # Plus bas (au lieu de top=0)
    screen.blit(img_disp, img_rect)

    # Deux petits rectangles plus bas sous l'image
    small_font = pygame.font.SysFont(None, 48)
    rects_top = img_rect.bottom + 60  # Décalage plus bas sous l'image
