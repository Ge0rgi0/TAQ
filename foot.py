...
SCREEN_HEIGHT = 960
SCREEN_WIDTH = 540
# Couleur du fond (modifiable ici)
BACKGROUND_COLOR = (24, 79, 14)  # Vert "pelouse"
...
CIRCLE_THICKNESS = 2
CIRCLE_SPEED = 3.0
CIRCLE_HOLE_WIDTH = 270
CIRCLE_HOLE_OFFSET = 0
...
TEXT_SUBTITLE = "(This is real this time)"
TEXT_YES = "PSG"
TEXT_NO = "Inter"
...
while running and frame_count < TOTAL_FRAMES:
    ...
    # Dernières 5*60 frames : rectangle question + réponse gagnante en blanc
    if frame_count >= TOTAL_FRAMES - 5*60:
        screen.fill(BACKGROUND_COLOR)
        # Rectangle blanc en haut avec texte noir (question)
        ...
        # Affiche la réponse gagnante en blanc, centré sous le rectangle
        ...
        if score_yes > score_no:
            ...
            winner = "Draw"
        text_winner = font_big.render(winner, True, (255, 255, 255))
        text_winner_rect = text_winner.get_rect(center=(SCREEN_WIDTH // 2, rect_bg.bottom + 80))
