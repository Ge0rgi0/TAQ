...
while running and frame_count < TOTAL_FRAMES:
    ...
    # Rectangle du haut : affiche l'image "capture.png" centrée en haut (plus gros)
    img_width = SCREEN_WIDTH - 20  # Plus large (au lieu de -80)
    ...
    img_rect = img_disp.get_rect(centerx=SCREEN_WIDTH // 2, top=20)  # Plus haut (au lieu de top=40)
    ...
    yes_rect.top = img_rect.bottom + 20
    yes_bg = pygame.Rect(
        yes_rect.left - 16,
        yes_rect.top - 12,
        yes_rect.width + 32,
    ...
    no_rect.top = img_rect.bottom + 20
    no_bg = pygame.Rect(
        no_rect.left - 16,
        no_rect.top - 12,
        no_rect.width + 32,
